...
async function fetchGameData(i) {
  ...
  const api_url =
    "https://sideshnew-zenwin.herokuapp.com/admin/gameView?gameType=ht&skip=" +
    s +
    "&limit=10";
...
function buildGameDataTable(tableData) {
  ...
  if (gameIds == 0) {
    ...
    heads.innerHTML = colors.green || 0;
    tails.innerHTML = colors.violet || 0;
    ...
    let headsW = document.getElementById("headsW");
    let tailsW = document.getElementById("tailsW");
    let totalW = document.getElementById("totalW");

    headsW.innerHTML = colors.green || 0;
    tailsW.innerHTML = colors.violet || 0;
    ...
    let headsP = document.getElementById("headsP");
    let tailsP = document.getElementById("tailsP");

    headsP.innerHTML = colors.green || 0;
    tailsP.innerHTML = colors.violet || 0;
